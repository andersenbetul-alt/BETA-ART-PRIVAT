...
const CAT_KEYS = [
  ...
  'Transport og avtaler', 'Trening og aktivitetsfølge', 'Pårørendekoordinering',
...
const COPY = {
  no: {
    ...
    hero: {
      ...
      h1: ['Eldreomsorgen,', 'koordinert —', 'på ett sted'],
      lead: 'NAVIAR CARE kartlegger behovet, matcher en kvalitetssikret hjelper og følger opp gjennomføringen — time for time, med full prisoversikt før bestilling. Fagfolk, tjenester og familie samlet rundt én plan.',
      ...
      cardRole: 'Sykepleier · Svarer nå',
      cardMsg: 'Basert på det du beskriver ser det ut til at mamma har klassiske tegn på UTI. Her er tre konkrete tiltak du kan gjøre akkurat nå...',
      cardMeta: 'Mottatt · 4 min etter forespørsel',
      cardInput: 'Skriv til en ekspert...',
    },
    how: {
    ...
    footer: {
      tagline: 'Koordinering av eldreomsorg i Norge — fagfolk, tjenester og familie på ett sted.',
  ...
  en: {
    ...
    hero: {
      ...
      h1: ['Elderly care,', 'coordinated —', 'in one place'],
      lead: 'NAVIAR CARE maps the need, matches a quality-assured helper and follows up on delivery — hour by hour, with the full price shown before you book. Professionals, services and family gathered around one plan.',
      ...
      cardRole: 'Nurse · Answering now',
      cardMsg: 'Based on what you describe, your mother seems to show classic signs of a UTI. Here are three concrete things you can do right now...',
      cardMeta: 'Received · 4 min after the request',
      cardInput: 'Write to an expert...',
    },
    how: {
    ...
    footer: {
      tagline: 'Coordination of elderly care in Norway — professionals, services and family in one place.',
  ...
  tr: {
    ...
    hero: {
      ...
      h1: ['Yaşlı bakımı,', 'tek yerden', 'koordine'],
      lead: 'NAVIAR CARE ihtiyacı belirler, kalite güvenceli bir yardımcıyla eşleştirir ve uygulamayı takip eder — saat saat, fiyat siparişten önce eksiksiz gösterilir. Uzmanlar, hizmetler ve aile tek planda buluşur.',
      ...
      cardRole: 'Hemşire · Şu an yanıtlıyor',
      cardMsg: 'Anlattıklarınıza göre annenizde klasik idrar yolu enfeksiyonu belirtileri görünüyor. Hemen yapabileceğiniz üç somut adım şunlar...',
      cardMeta: 'Alındı · talepten 4 dk sonra',
      cardInput: 'Bir uzmana yazın...',
    },
    how: {
    ...
    footer: {
      tagline: 'Norveç\'te yaşlı bakım koordinasyonu — uzmanlar, hizmetler ve aile tek yerde.',
      ...
      <div style={{
        ...
        {step === 'done' ? (
          <div style={{ textAlign: 'center', paddingTop: 16 }}>
            ...
            <h3 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 26, fontWeight: 700, color: '#173d3a', marginBottom: 12 }}>{L.modal.thanks} {name.split(' ')[0]}!</h3>
            <p style={{ fontSize: 15, color: '#576b68', lineHeight: 1.6, marginBottom: 28 }}>
              {L.modal.done1} <strong>{email}</strong> {L.modal.done2}
            </p>
            <p style={{ fontSize: 12, color: '#576b68' }}>{L.modal.pilotNote}</p>
          ...
          <>
            <div style={{ marginBottom: 28 }}>
              <span style={{ fontFamily: '"DM Mono", monospace', fontSize: 10, letterSpacing: '0.1em', color: '#576b68', textTransform: 'uppercase' }}>{L.modal.kicker}</span>
              <h3 id="nc-modal-title" style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 24, fontWeight: 700, color: '#173d3a', marginTop: 8 }}>{L.modal.title}</h3>
              <p style={{ fontSize: 14, color: '#576b68', marginTop: 6 }}>{L.modal.lead}</p>
            </div>

            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                <div>
                  <label htmlFor="nc-name" style={{ fontSize: 12.5, fontWeight: 600, color: '#173d3a', display: 'block', marginBottom: 6 }}>{L.modal.name}</label>
                ...
                <div>
                  <label htmlFor="nc-email" style={{ fontSize: 12.5, fontWeight: 600, color: '#173d3a', display: 'block', marginBottom: 6 }}>{L.modal.email}</label>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                <div>
                  <label htmlFor="nc-phone" style={{ fontSize: 12.5, fontWeight: 600, color: '#173d3a', display: 'block', marginBottom: 6 }}>{L.modal.phone}</label>
                ...
                <div>
                  <label htmlFor="nc-topic" style={{ fontSize: 12.5, fontWeight: 600, color: '#173d3a', display: 'block', marginBottom: 6 }}>{L.modal.topic}</label>
              ...
              <div>
                <label htmlFor="nc-situation" style={{ fontSize: 12.5, fontWeight: 600, color: '#173d3a', display: 'block', marginBottom: 6 }}>{L.modal.situation}</label>
  ...
  return (
    <>
      <button
        ...
        <NaviAvatar size={36} />
        <span style={{ color: '#fffdf8', fontSize: 14, fontWeight: 700 }}>{open ? L.navi.close : L.navi.open}</span>
      </button>
        ...
        <div role="region" aria-label={L.navi.region} style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '12px 16px', background: '#173d3a' }}>
            ...
            <div style={{ lineHeight: 1.2 }}>
              <div style={{ color: '#fffdf8', fontSize: 14, fontWeight: 700 }}>{L.navi.name}</div>
              <div style={{ color: '#7db5ad', fontSize: 11 }}>{L.navi.sub}</div>
            </div>
          </div>
...
function LangSwitch({ lang, setLang, compact = false }: { lang: Lang; setLang: (l: Lang) => void; compact?: boolean }) {
  ...
  return (
    <div role="group" aria-label="Språk / Language / Dil" style={{ display: 'flex', gap: 2, background: '#f7f5ef', border: '1px solid #cbd8d0', borderRadius: 100, padding: 2 }}>
      {langs.map(l => (
        <button key={l.code} onClick={() => setLang(l.code)}
          ...
          style={{
            ...
            background: lang === l.code ? '#173d3a' : 'transparent',
            color: lang === l.code ? '#fffdf8' : '#576b68',
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ marginBottom: 32 }}>
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '5px 14px 5px 10px', background: '#d9ebe2', borderRadius: 100 }}>
            ...
            <span style={{ fontFamily: '"DM Mono", monospace', fontSize: 11, letterSpacing: '0.1em', color: '#173d3a', textTransform: 'uppercase' }}>{L.hero.badge}</span>
          </span>
        </div>
        ...
        <div style={{ display: 'flex', gap: 60, alignItems: 'flex-start', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: '1 1 480px', maxWidth: 620 }}>
            <h1 style={{
              ...
              {L.hero.h1[0]}<br/>{L.hero.h1[1]}<br/>{L.hero.h1[2]}
            </h1>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginTop: 16 }}>
              ...
              <span style={{ fontSize: 12.5, color: '#576b68' }}>{L.hero.gdpr}</span>
            </div>
            {/* Service area */}
            <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginTop: 8 }}>
              ...
              <span style={{ fontSize: 12.5, color: '#576b68' }}>{L.hero.area}</span>
            </div>
            ...
            <p style={{ fontSize: 11, color: '#576b68', marginTop: 10 }}>{L.hero.statsNote}</p>
          </div>
            ...
            <div style={{
              ...
              <div style={{ marginBottom: 20 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: '#576b68' }}>{L.hero.cardRole}</div>
                  </div>
                ...
                <div style={{ fontSize: 11, color: '#576b68', textAlign: 'right' }}>{L.hero.cardMeta}</div>
              </div>
              ...
              <div style={{ borderTop: '1px solid #cbd8d0', paddingTop: 16 }}>
                <button onClick={onCta} style={{
                  ...
                  <span style={{ fontSize: 13, color: '#576b68', flex: 1 }}>{L.hero.cardInput}</span>
    ...
    <section id="how" style={{ background: '#fffdf8', padding: '80px 24px', scrollMarginTop: 68 }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ marginBottom: 56 }}>
          <span style={{ fontFamily: '"DM Mono", monospace', fontSize: 11, letterSpacing: '0.1em', color: '#576b68', textTransform: 'uppercase' }}>{L.how.kicker}</span>
          <h2 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 'clamp(28px, 3.5vw, 42px)', fontWeight: 700, color: '#173d3a', marginTop: 12, letterSpacing: '-0.02em' }}>{L.how.h2}</h2>
        </div>
    ...
    <section id="tjenester" style={{ background: '#f7f5ef', padding: '80px 24px', scrollMarginTop: 68 }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ marginBottom: 48 }}>
          <span style={{ fontFamily: '"DM Mono", monospace', fontSize: 11, letterSpacing: '0.1em', color: '#576b68', textTransform: 'uppercase' }}>{L.cats.kicker}</span>
          <h2 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 'clamp(28px, 3.5vw, 42px)', fontWeight: 700, color: '#173d3a', marginTop: 12, letterSpacing: '-0.02em' }}>{L.cats.h2}</h2>
          ...
          {ordered.map(c => (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                ...
                <span style={{ fontFamily: '"DM Mono", monospace', fontSize: 10, letterSpacing: '0.06em', padding: '2px 7px', background: c.key === top ? '#d8ef75' : '#d9ebe2', color: '#173d3a', borderRadius: 4 }}>{c.key === top ? L.cats.last : c.code}</span>
              </div>
...
function PilotStatus({ L }: { L: Copy }) {
  const col = (title: string, items: string[], active: boolean) => (
    <div style={{ flex: '1 1 300px', background: '#fffdf8', border: '1px solid #cbd8d0', borderRadius: 12, padding: '28px 28px 24px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 18 }}>
        <span style={{ width: 8, height: 8, borderRadius: '50%', background: active ? '#0a7d72' : '#cbd8d0', flexShrink: 0 }} />
        <span style={{ fontFamily: '"DM Mono", monospace', fontSize: 11, letterSpacing: '0.08em', color: '#173d3a', textTransform: 'uppercase', fontWeight: 700 }}>{title}</span>
      </div>
        ...
        {items.map((it, i) => (
          <li key={i} style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
            {active ? (
              ...
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#576b68" strokeWidth="2" strokeLinecap="round" style={{ flexShrink: 0, marginTop: 3 }}>
                <circle cx="12" cy="12" r="10"/><path d="M12 7v5l3 3"/>
              </svg>
            )}
            <span style={{ fontSize: 14.5, lineHeight: 1.55, color: '#576b68' }}>{it}</span>
          </li>
        ))}
      </ul>
    </div>
  ...
  return (
    <section id="pilotstatus" style={{ background: '#fffdf8', padding: '80px 24px', scrollMarginTop: 68 }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ marginBottom: 40 }}>
          <span style={{ fontFamily: '"DM Mono", monospace', fontSize: 11, letterSpacing: '0.1em', color: '#576b68', textTransform: 'uppercase' }}>{L.pilot.kicker}</span>
          <h2 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 'clamp(28px, 3.5vw, 42px)', fontWeight: 700, color: '#173d3a', marginTop: 12, letterSpacing: '-0.02em' }}>{L.pilot.h2}</h2>
          <p style={{ fontSize: 16, color: '#576b68', marginTop: 12, maxWidth: 520 }}>{L.pilot.lead}</p>
        </div>
...
function Testimonials({ L }: { L: Copy }) {
  return (
    <section style={{ background: '#f7f5ef', padding: '80px 24px', scrollMarginTop: 68 }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ marginBottom: 48 }}>
          <span style={{ fontFamily: '"DM Mono", monospace', fontSize: 11, letterSpacing: '0.1em', color: '#576b68', textTransform: 'uppercase' }}>{L.testi.kicker}</span>
          <h2 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 'clamp(28px, 3.5vw, 42px)', fontWeight: 700, color: '#173d3a', marginTop: 12, letterSpacing: '-0.02em' }}>{L.testi.h2}</h2>
        </div>
        ...
        <p style={{ fontSize: 12, color: '#576b68', marginTop: 20 }}>{L.testi.note}</p>
      </div>
    </section>
  )
}
...
function Experts({ L, onCta }: { L: Copy; onCta: (topic?: string) => void }) {
  return (
    <section id="experts" style={{ background: '#fffdf8', padding: '80px 24px', scrollMarginTop: 68 }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ marginBottom: 48 }}>
          <span style={{ fontFamily: '"DM Mono", monospace', fontSize: 11, letterSpacing: '0.1em', color: '#576b68', textTransform: 'uppercase' }}>{L.experts.kicker}</span>
          <h2 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 'clamp(28px, 3.5vw, 42px)', fontWeight: 700, color: '#173d3a', marginTop: 12, letterSpacing: '-0.02em' }}>{L.experts.h2}</h2>
          <p style={{ fontSize: 16, color: '#576b68', marginTop: 12, maxWidth: 480 }}>{L.experts.lead}</p>
        </div>
    ...
    <section id="fritid" style={{ background: '#d9ebe2', padding: '80px 24px', scrollMarginTop: 68 }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', gap: 56, flexWrap: 'wrap', alignItems: 'flex-start' }}>
        <div style={{ flex: '1 1 420px', maxWidth: 560 }}>
          <span style={{ fontFamily: '"DM Mono", monospace', fontSize: 11, letterSpacing: '0.1em', color: '#576b68', textTransform: 'uppercase' }}>{L.fritid.kicker}</span>
          <h2 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 'clamp(28px, 3.5vw, 42px)', fontWeight: 700, color: '#173d3a', marginTop: 12, letterSpacing: '-0.02em' }}>{L.fritid.h2}</h2>
    ...
    <section id="priser" style={{ background: '#f7f5ef', padding: '80px 24px', scrollMarginTop: 68 }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ marginBottom: 52, maxWidth: 540 }}>
          <span style={{ fontFamily: '"DM Mono", monospace', fontSize: 11, letterSpacing: '0.1em', color: '#576b68', textTransform: 'uppercase' }}>{L.pricing.kicker}</span>
          <h2 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 'clamp(28px, 3.5vw, 42px)', fontWeight: 700, color: '#173d3a', marginTop: 12, letterSpacing: '-0.02em' }}>{L.pricing.h2}</h2>
          <p style={{ fontSize: 16, color: '#576b68', marginTop: 12, lineHeight: 1.6 }}>{L.pricing.lead}</p>
        </div>
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginTop: 10, marginBottom: 4 }}>
                  {!/^\d/.test(p.price) ? (
                    ...
                    <>
                      <span style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 36, fontWeight: 700, color: p.highlight ? '#fffdf8' : '#173d3a' }}>{L.pricing.currency} {p.price}</span>
    ...
    <section id="for-section" style={{ background: '#fffdf8', padding: '80px 24px', scrollMarginTop: 68 }}>
      <div style={{
        ...
        <div style={{ background: '#f7f5ef', padding: '52px 48px' }}>
          <span style={{ fontFamily: '"DM Mono", monospace', fontSize: 10, letterSpacing: '0.1em', color: '#576b68', textTransform: 'uppercase' }}>{L.forSec.k1}</span>
          <h3 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 'clamp(22px, 2.5vw, 30px)', fontWeight: 700, color: '#173d3a', marginTop: 10, marginBottom: 28, letterSpacing: '-0.01em' }}>{L.forSec.h1[0]}<br/>{L.forSec.h1[1]}</h3>
        ...
        <div style={{ background: '#d9ebe2', padding: '52px 48px' }}>
          <span style={{ fontFamily: '"DM Mono", monospace', fontSize: 10, letterSpacing: '0.1em', color: '#576b68', textTransform: 'uppercase' }}>{L.forSec.k2}</span>
          <h3 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 'clamp(22px, 2.5vw, 30px)', fontWeight: 700, color: '#173d3a', marginTop: 10, marginBottom: 28, letterSpacing: '-0.01em' }}>{L.forSec.h2[0]}<br/>{L.forSec.h2[1]}</h3>
          <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 36px' }}>
            {L.forSec.l2.map((p, i) => (
              <li key={i} style={{ display: 'flex', gap: 12, alignItems: 'flex-start', marginBottom: 14 }}>
                <span style={{ flexShrink: 0, marginTop: 2 }}>{check}</span>
  ...
  return (
    <section id="faq" style={{ background: '#f7f5ef', padding: '80px 24px', scrollMarginTop: 68 }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <div style={{ marginBottom: 48 }}>
          <span style={{ fontFamily: '"DM Mono", monospace', fontSize: 11, letterSpacing: '0.1em', color: '#576b68', textTransform: 'uppercase' }}>{L.faq.kicker}</span>
          <h2 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 'clamp(28px, 3.5vw, 42px)', fontWeight: 700, color: '#173d3a', marginTop: 12, letterSpacing: '-0.02em' }}>{L.faq.h2}</h2>
        </div>
      ...
      <div style={{ maxWidth: 560, margin: '0 auto' }}>
        ...
        {done ? (
          <div style={{ padding: '20px 28px', background: 'rgba(216,239,117,0.12)', borderRadius: 10, border: '1px solid rgba(216,239,117,0.25)', maxWidth: 380, margin: '0 auto' }}>
            <div style={{ fontSize: 16, fontWeight: 700, color: '#d8ef75', marginBottom: 6 }}>{L.finalCta.thanks}</div>
            <p style={{ fontSize: 14, color: '#7db5ad', margin: 0 }}>{L.finalCta.thanksSub}</p>
          </div>
        ) : (
          <>
            ...
            <p style={{ fontSize: 13, color: '#7db5ad', marginTop: 16 }}>{L.finalCta.noBind}</p>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: 32, marginBottom: 32 }}>
          ...
          <div style={{ maxWidth: 260 }}>
            ...
            <p style={{ fontSize: 13, color: '#7fa8a2', lineHeight: 1.55, margin: 0 }}>{L.footer.tagline}</p>
            <p style={{ fontSize: 12, color: '#7fa8a2', lineHeight: 1.55, margin: '8px 0 0' }}>{L.footer.area}</p>
          </div>

          {/* Links */}
          <div style={{ display: 'flex', gap: 52, flexWrap: 'wrap' }}>
            <div>
              <div style={{ fontFamily: '"DM Mono", monospace', fontSize: 10, letterSpacing: '0.08em', color: '#7fa8a2', textTransform: 'uppercase', marginBottom: 12 }}>{L.footer.col1}</div>
            ...
            <div>
              <div style={{ fontFamily: '"DM Mono", monospace', fontSize: 10, letterSpacing: '0.08em', color: '#7fa8a2', textTransform: 'uppercase', marginBottom: 12 }}>{L.footer.col2}</div>
        ...
        <div style={{ borderTop: '1px solid #1a3d3a', paddingTop: 24, display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12, alignItems: 'center' }}>
          <p style={{ fontFamily: '"DM Mono", monospace', fontSize: 11, color: '#7fa8a2', margin: 0 }}>{L.footer.copyright}</p>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
            ...
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
              ...
              <span style={{ fontSize: 12, color: '#7fa8a2' }}>{L.footer.gdpr}</span>
            </span>
          </div>
        </div>
      </div>
