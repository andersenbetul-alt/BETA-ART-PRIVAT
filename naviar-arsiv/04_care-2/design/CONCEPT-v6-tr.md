...
**Belge:** DOS-001 · Güncel ana belge · 6.0  
**Tarih:** 5 Eylül 2026  
**Web sitesi:** [NAVIAR CARE 2](https://naviar-care-2.andersen-betul.chatgpt.site/tr/)

Bu belge konsepti, mevcut yazılımı ve gerçek hizmete geçiş işlerini tek yerde birleştirir. Önceki DOS-001 v1.0 konseptinin devamıdır. İlk kararların geçmişi korunmuştur; bugünkü yazılım kapsamı daha geniştir. Konsept, üç dilli web sitesi ve teknik demo teslim edilmiştir. Gerçek sağlık hizmeti, hekim görüşmesi, canlı ödeme ve otomatik e-posta teslimatı bu teslimle açılmış değildir.
...
İç kanıt: proje deposunun kaynak dosyaları; `design/REVIEW-v4.md`, `design/RELEASE-v5.md`; önceki DOS-001 v1.0; 5 Eylül teslim kaydı ve bu sürümün test çıktısı. Güncel web metinleri ayrıca üç dilde, sayfa sırasıyla teslim edilir. Eski belgeler tarihsel kayıt olarak kalır; mevcut kapsam için bu ana belge kullanılır.
